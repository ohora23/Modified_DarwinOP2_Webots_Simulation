...
#define DOP2STATEPUB // DARWINOP2State Publish
...
#include <webots_ros/DarwinOP2State.h>

#include <webots_ros/get_floatarray.h>
...
#define NMOTORS 20
#define NTSENSORS 8 // # of touch sensors
#define HALF_NTSENSORS 4
...
private:
  ...
  bool getMotorValuesCallback(webots_ros::get_floatarray::Request &req, webots_ros::get_floatarray::Response &res);
  bool publishDarwinOP2State(webots_ros::DarwinOP2State &darwin_state);

  bool enableDarwinOP2StateUpdate(webots_ros::set_int::Request &req, webots_ros::set_int::Response &res);
  bool setMotorPositionsCallback(webots_ros::set_float_array::Request & req, webots_ros::set_float_array::Response &res);
  ...
  //2019-01-18 00:01:48: JKYOO
  ros::ServiceServer mGetMotorValuesService;
  ros::ServiceServer mStartDarwinOP2StateTransmitService;
  ros::ServiceServer mSetMotorPositionsService;


  ros::Publisher mClockPublisher;

  // DarwinOP2 state publisher
  ros::Publisher mDarwinOP2StatePublisher;
