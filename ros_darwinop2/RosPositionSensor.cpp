...
RosPositionSensor::RosPositionSensor(PositionSensor *positionSensor, Ros *ros) :
  ...
  // mGetMotorNameServer = RosDevice::rosAdvertiseService(ros->name() + '/' + RosDevice::fixedDeviceName() + "/get_motor_position",
  //                                                      &RosPositionSensor::getMotorPositionCallback);
}
...
// bool RosPositionSensor::getMotorPositionCallback(webots_ros::get_string::Request &req, webots_ros::get_float::Response &res) {
//   res.value= mPositionSensor->getValue();
//   return true;
// }
